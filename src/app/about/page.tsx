    ...
    <main className="h-screen w-screen overflow-hidden bg-[#F5F5F5] text-[#1A1A1A] flex flex-col font-sans antialiased selection:bg-[#E2FF33]">
      ...
      <nav className="h-12 border-b border-[#E5E5E5] px-4 flex justify-between items-center bg-white flex-shrink-0">
        ...
        <div className="flex gap-4 text-[10px] font-bold uppercase tracking-widest text-[#999]">
          <Link href="/" className="hover:text-black transition-colors">Burned</Link>
          <Link href="/about" className="text-black transition-colors">About</Link>
        </div>
      </nav>

      {/* Main Content Area - Allowing scroll here to prevent cutoff */}
      <div className="flex-1 overflow-y-auto bg-[#F0F0F0] p-4 lg:p-12 flex justify-center items-start">
        <div className="max-w-2xl w-full bg-white border border-[#E5E5E5] p-6 lg:p-16 my-4 lg:my-8 shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_30px_60px_-12px_rgba(0,0,0,0.12)]">
          <header className="mb-10 lg:mb-12 border-b border-black pb-8">
            <span className="block text-[10px] font-bold uppercase tracking-[0.3em] text-[#999] mb-4">Historical Archive</span>
            <h1 className="text-4xl lg:text-7xl font-black tracking-tighter leading-[0.85] uppercase">
              The Burned<br />Nouns Era
            </h1>
          </header>

          <div className="space-y-6 text-sm lg:text-base leading-relaxed text-[#444] font-medium">
            <p>
            ...
            <div className="bg-[#F5F5F5] p-5 lg:p-6 border-l-4 border-black my-8">
              <span className="block text-[9px] font-bold uppercase tracking-widest text-[#999] mb-2">Scope of Records</span>
              <p className="text-lg lg:text-xl font-bold tracking-tight text-black italic">
          ...
          <div className="mt-12 lg:mt-16 pt-8 border-t border-[#E5E5E5] flex justify-between items-center">
            ...
            <span className="font-mono text-[9px] text-[#999]">ARCHIVE_DOC_955_968</span>
          </div>
        </div>
      </div>
