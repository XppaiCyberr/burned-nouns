    ...
    <main className="h-screen w-screen overflow-hidden bg-[#F5F5F5] text-[#1A1A1A] flex flex-col font-sans antialiased selection:bg-[#E2FF33]">
      ...
      <nav className="h-12 border-b border-[#E5E5E5] px-4 flex justify-between items-center bg-white flex-shrink-0">
        ...
        <div className="flex gap-4 text-[10px] font-bold uppercase tracking-widest text-[#999]">
          <Link href="/" className="hover:text-black transition-colors">Explorer</Link>
      ...
      {/* Main Content Area */}
      <div className="flex-1 overflow-y-auto bg-[#F0F0F0] p-6 lg:p-12 flex justify-center items-start lg:items-center">
        <div className="max-w-2xl w-full bg-white border border-[#E5E5E5] p-8 lg:p-16 shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_30px_60px_-12px_rgba(0,0,0,0.12)]">
          ...
          <div className="space-y-6 text-sm lg:text-base leading-relaxed text-[#444] font-medium">
            ...
            <div className="bg-[#F5F5F5] p-6 border-l-4 border-black my-8">
              <span className="block text-[9px] font-bold uppercase tracking-widest text-[#999] mb-2">Scope of Records</span>
              <p className="text-xl font-bold tracking-tight text-black italic">
      ...
      <footer className="h-8 border-t border-[#E5E5E5] px-4 flex justify-between items-center bg-white text-[9px] text-[#999] uppercase tracking-widest flex-shrink-0">
        <span>Historical Record v1.0</span>
